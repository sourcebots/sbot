...
from sbot import timeout
from sbot.future.board_manager import IN_SIMULATOR, BoardManager, DiscoveryTemplate
from sbot.future.overrides import get_overrides
from sbot.game_specific import GAME_LENGTH
from sbot.utils import float_bounds_check

from .comp import Comp
from .internal.start_led import flash_start_led, set_start_led

try:
    from sbot.mqtt import MQTT_VALID, RemoteStartButton
except ImportError:
    MQTT_VALID = False
...
class Utils:
    ...
    def wait_start(self) -> None:
        ...
        if self._comp.is_competition and not IN_SIMULATOR:
            timeout.kill_after_delay(GAME_LENGTH)
